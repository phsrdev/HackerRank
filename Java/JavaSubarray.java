...
1 - The sum of an array is the total sum of its elements.
2 - An array's sum is negative if the total sum of its elements is negative.
3 - An array's sum is positive if the total sum of its elements is positive.
