...
public class JavaRegex2DuplicateWords {
    ...
    public static void main(String[] args) {
        ...
        String regex = /* Write a RegEx matching repeated words here. */"\\b(\\w+)(\\b\\W+\\b\\1\\b)*";
        Pattern p = Pattern.compile(regex, /* Insert the correct Pattern flag here.*/Pattern.MULTILINE + Pattern.CASE_INSENSITIVE);
