...
1 - A string, s, of length n where s = c0,c1...cn-1.
...
2 - int k: the size of substrings to analyze
...
Split 8 into n/k = 9/3 = 3 equal parts of length k=3. Convert each ti to ui by removing any subsequent occurrences of non-distinct characters in ti:
