if __name__ == '__main__':
    s = input()
    #verifica em cada iteracao se o algoritimo possui a funcao, em caso positivo retorna True em caso negativo retorna False# 
    print(any([i.isalnum() for i in (s)]))
    # primeira verificacao se tem alfanumerico
    print(any([i.isalpha() for i in (s)]))
    # segunda verificacao se tem letras
    print(any([i.isdigit() for i in (s)]))
    # terceira verificacao se tem numero
    print(any([i.islower() for i in (s)]))
    # quarta verificacao se tem minusculo
    print(any([i.isupper() for i in (s)]))  
    # quinta verificacao se tem maiusculo
'''
